...
import com.xyd.student.xydexamanalysis.zxinglib.CameraPreview;
import com.xyd.student.xydexamanalysis.zxinglib.CameraUtils;
import com.xyd.student.xydexamanalysis.zxinglib.DisplayUtils;
...
public class ZXingScannerViewNew extends FrameLayout implements
	...
	private void startFreshThread(final Camera camera,
	...
	public void onPreviewFrame(byte[] data, Camera camera) {
		...
		PlanarYUVLuminanceSource source = buildLuminanceSource(data, width,
				height);
		if (source != null) {
