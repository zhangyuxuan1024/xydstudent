...
public class LoadingHelper {
	...
	public LoadingHelper(View rootView, View emptyView) {
		promptLayout = (LinearLayout) rootView
				.findViewById(R.id.loading_prompt_linear);
		promptProgress = (ProgressBar) rootView
				.findViewById(R.id.loading_prompt_progress);
	...
	public void ShowLoading() {
		...
		promptText.setText(R.string.s_loading_show_start);
	...
	public void ShowEmptyData() {
		...
		emptyText.setText(R.string.s_loading_show_empty);
	}
